...
function Home() {
  ...
  const slidesData = [
    { image: "/src/assets/img/image copy 4.png", title: "TE", Link: "#" },
    { image: "/src/assets/img/image copy 5.png", title: "MW", Link: "#" },
    { image: "/src/assets/img/image copy 6.png", title: "HS", Link: "#" },
  ];
  ...
  const PresidentBooksImages = [
    { src: '/src/assets/img/image copy.png', title: t('HC'), href: 'https://moh.tj/wp-content/uploads/2024/05/programm_2016-2020_tj.pdf' },
    { src: '/src/assets/img/image copy 2.png', title: t('ND'), href: 'https://moh.tj/wp-content/uploads/2024/05/strategiyai_millii_rushdi_cht_baroi_davrai_to_soli_2030.pdf' },
    { src: '/src/assets/img/image copy 3.png', title: t('HC'), href: 'https://moh.tj/wp-content/uploads/2024/05/programm_2016-2020_tj.pdf' }
  ]
  ...
  return (
    <div className="w-full">
      <div className='rounded-xl' style={{ backgroundImage: 'url("/src/assets/img/Recording 2024-11-04 072646 dw- Trim (1).gif")', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        <div className="flex flex-col gap-2 p-4 dark:bg-black/30 bg-white/30 backdrop-blur-sm rounded-md shadow-xl items-center">
          <img className="rounded-lg w-full max-w-[200px] h-auto " src="/src/assets/img/image.png" alt="President" />
